...
@section('title', 'Teams | East County Performing Arts Center')
...
@section('content')
    ...
    <div class="container my-5">
        <h2 class="text-center mt-3 font-weight-bold">Performing Company</h2>
        <div class="row my-4">
            <div class="col-md">
                <p>
                    ...
                    <br><br><a href="https://ecpacnews.com/performing-company/" target="_blank">Performing Company News</a>
                </p>
                <p class="lead font-weight-bold mb-0" style="color: #12a9b0;">Performing Company Placements</p>
                <p>
                    DATE- TBD
                    <br>Audition forms will need to be completed by TBD
                </p>
                <p class="lead font-weight-bold mb-0" style="color: #12a9b0;">Informational Webinar</p>
                <p>
                    Date TBD
        ...
        <h2 class="text-center mt-3 font-weight-bold">Competition Team</h2>
        <p>
            ...
            <br><br><a href="https://ecpacnews.com/comp-team-info/" target="_blank">ECPAC Comp Team News</a>
            <br><br>
