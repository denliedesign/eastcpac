...
<div class="d-none d-md-block">
    ...
    <div class="banner-wrap my-3">
        <div class="banner">
            <div class="d-flex justify-content-center" style="position:relative; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                <img src="/images/ballet-company-of-east-county-logo.png" alt="The Ballet Company Of East County" class="img-fluid" style="max-width: 500px; height: auto;">
            </div>
        </div>
    </div>
</div>
